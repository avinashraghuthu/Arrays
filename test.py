...

-----END RSA PRIVATE KEY-----
"""
...
def install_cli_tools():
    ...
    # 10.13 receipt name
    if '10.15' in os_ver:
        print("Running Catalina, nothing to install")
        return True
    if '10.14' in os_ver:
        print("Running Mojave, nothing to install")
        return True
    if '10.13' in os_ver:
    ...
    if (
        ...
        if int(results['status']) != 0:
            ...
            #pyton3 style print would be - print('Software update failed!', file=sys.stderr)
            sys.exit(1)
        ...
        if (is_pkg_installed('com.apple.pkg.CLTools_Executables') != '0.0.0.0'
                and is_pkg_installed(receipt) != '0.0.0.0'):
